/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d80e36073c4fef97d117795012501efb)
// Runtime types generated with workerd@1.20260212.0 2025-10-08 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "YTContainer";
	}
	interface Env {
		TRANSCRIPT_BUCKET: R2Bucket;
		TRANSCRIPT_DB: D1Database;
		YT_CONTAINER: DurableObjectNamespace<import("./src/index").YTContainer>;
		TRANSCRIPT_WORKFLOW: Workflow<Parameters<import("./src/index").TranscriptWorkflow['run']>[0]['payload']>;
	}
}
